...
if __name__=='__main__':
    for province,cities in area.items():
        os.mkdir('./report_picture/'+province)
        os.mkdir('./GeoJson/province-city/'+province)
        os.mkdir('./illageRegionRaster/{}'.format(province))
        os.mkdir('./manager-landuse-image/{}'.format(province))
        for city in cities:
            os.mkdir('./illageRegionRaster/{}/{}'.format(province,city))
            os.makedirs('./GeoJson/province-city-county/{}/{}'.format(province,city))
